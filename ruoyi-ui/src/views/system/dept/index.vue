<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="email" label="人数"  width="200"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="部班级名称" prop="deptName">
          ...
          <el-col :span="12">
            <el-form-item label="人数" prop="email">
              <el-input v-model="form.email" placeholder="请输入人数" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
